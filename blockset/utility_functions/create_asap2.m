function create_asap2(modelName, XCPport, XCPaddress, XCPstationID, Target, MAPfile, medium, can_send_id, can_receive_id)
	...
	% medium........ Transport medium i.e. TCP/UDP/CAN
	% can_send_id    The id the controller is sending on
	% can receive_id The id the controller is listening on
	%
	% sources:
	...
	base = GOcontrollASAP2(XCPport, XCPaddress, XCPstationID, XCPstationIDAddress, Target, medium, can_send_id, can_receive_id);
